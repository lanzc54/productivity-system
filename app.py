...
if __name__ == "__main__":
    ...
    port = int(os.environ.get("PRODUCTIVITY_PORT", "5000"))
    debug = os.environ.get("PRODUCTIVITY_DEBUG", "false").lower() == "true"
>>>>>>> 7ab5c37 (Add audit engagement reporting and assignments)
